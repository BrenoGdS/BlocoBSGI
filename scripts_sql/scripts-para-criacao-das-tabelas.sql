...
CREATE TABLE Tb_Lider_Organizacional (
    id_lider_organizacional INTEGER AUTO_INCREMENT PRIMARY KEY NOT NULL,
...
CREATE TABLE Tb_Organizacao (
    id_organizacao INTEGER AUTO_INCREMENT PRIMARY KEY NOT NULL,
...
CREATE TABLE Tb_Usuario_Organizacao (
    id_usuario_organizacao INTEGER AUTO_INCREMENT PRIMARY KEY NOT NULL,
    id_usuario INTEGER,
    id_organizacao INTEGER
);
...
ALTER TABLE Tb_Usuario ADD CONSTRAINT FK_Tb_Usuario_2
    ...
    REFERENCES tb_tipo_sexo (cod_tipo_sexo);
