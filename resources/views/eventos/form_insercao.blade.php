...
<html lang="pt-br">
    ...
    <title> BSGI - Eventos-insert </title>
...
<body>
  ...
  <!--  <form id="formulario" action="insercao_organizacao-v1.4.php" method="GET">-->
    ...
    ?>
        ...
        <form action="{{ route('salvarEvento') }}"  method="POST" style="margin: 6%">
            ...
            <div class="row">
                <div class="col-sm">
                    ...
                    <label class="label-index" for="organizacao" id="organizacao"
                           value="{{-- $evento->titulo --}}">
                    Organização:
                    <!-- Em caso de problema, copiar form_edicao -->
                    </label>
                        <?php
                        /*
                        try{
        ...
        <label class="label-index" for="tipo" id="tipo">
            ...
            <select name="id_lider_organizacional1" id="idLiderOrg1" class="form-control mb-1 mr-sm-2">
                    <option default value="">Encontro Cultural</option>
                    <option value="1">Encontro Cultural</option>
                    <option value="2">Exposição Cultural</option>
                    <option value="3">Reunião de Bloco</option>
                    <option value="4">Reunião de Estudo</option>
                    <option value="5">Reunião de Palestra</option>
            </select>
  ...
  <div class="row">
    <div class="col-sm">
        ...
        <div class="col-sm">
          ...
          <input type="text" class="form-control" name="cep" id="cep" value="" onblur="pesquisacep(this.value);">
