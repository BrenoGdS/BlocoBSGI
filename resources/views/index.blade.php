    ...
    <header>
  	...
  	<div id="cab_esq">
        ...
        <!-- novos icones azuis -->    
                ...
                <a href="http://localhost/frontend/index.php"><img src="{{ Storage::url('/ic-home-b2-128.png')}}" height="9%"></a>
        </div>
    </header>
    
    <section id="barra"> </section>
    <section id="main">
        <h1 class="titulo">Preencha abaixo ao menos um dos campos para busca</h1>
